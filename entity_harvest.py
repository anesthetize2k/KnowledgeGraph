...
- DO NOT infer or assume entities that might be related but aren't directly named.
- If unsure, omit it.
- Focus on proper nouns and specific brand/company names that appear in the text.
Passage:
\"\"\"{text}\"\"\"
"""
